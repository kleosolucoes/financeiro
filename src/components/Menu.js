		...
		return (
			<div className={classes.root}>
				...
				>
					<Toolbar disableGutters={!open}>
						...
						<Typography variant="h6" color="inherit" noWrap>
							{this.state.tela && capitalizeFirstLetter(this.state.tela)}
						</Typography>
					</Toolbar>
				</AppBar>
				<Drawer
				...
				>
					...
					<Divider />
					<List>
						{['extratoEmpresa', 'lancarVarios', 'extratoAdministracao', 'lancarUm', 'lancamentos', 'categorias', 'empresas',].map((tela, index) => (
